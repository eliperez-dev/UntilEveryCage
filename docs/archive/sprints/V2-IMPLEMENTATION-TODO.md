...
Current evidence is summarized in [V2-BACKEND-PHASE-0-CLOSEOUT.md](V2-BACKEND-PHASE-0-CLOSEOUT.md). That report distinguishes verified backend behavior from unresolved public-production blockers. The current overall roadmap is [PRODUCT-READINESS.md](../../PRODUCT-READINESS.md).
...
- [Archived V2 design and implementation roadmap](../research/v2-ideas.md)
