...
The owner-authorized 2026-09-15 live-country rehearsal remains the historical synthetic/private baseline. On 2026-09-17, official Germany and Belgium artifacts were captured privately and publication-blocked. On 2026-09-23, the explicitly approved FASFC pair completed one strict live E2E through the shared runner and a disposable private database; this is a source-specific acquisition check, not recurring runtime health. See the row-free [Belgium live evidence manifest](../data/manifests/be-fasfc-live-refresh-2026-09-23.json), [historical Germany/Belgium manifest](../data/manifests/de-be-private-candidates-2026-09-17.json), and detailed country packets.
...
| `be.locations` | verified | verified | not_run | blocked | 2026-09-23 live operator/codebook pair: 310,764 input activity rows, 4,033 PAP-code-signature animal-scope observations, 1,793 distinct source-scoped facility candidates, 20 quarantined; disposable DB import and saved-handoff replay verified; runtime health remains not_run and public release remains blocked; see `data/manifests/be-fasfc-live-refresh-2026-09-23.json` and `docs/review-packet-belgium.md` |
| `fr.dgal.section-i` | verified | artifact_private_only | unknown | blocked | 2026-09-16 current private capture: 1,448 input/normalized, 0 quarantined; focused disposable France rehearsal passes on synthetic fixtures, while terms, category/identity, address privacy, geospatial review, and project approval remain open; see `docs/review-packet-france.md` |
| `fr.dgal.section-ii` | verified | artifact_private_only | unknown | blocked | 2026-09-16 current private capture: 1,068 input/normalized, 0 quarantined; Section II remains separate and the focused disposable rehearsal passes on synthetic fixtures, while species/category semantics, terms, address privacy, geospatial review, and project approval remain open; see `docs/review-packet-france.md` |
...
| `it.1069-2009` | verified | verified | not_run | blocked | 2026-09-24 live one-command private E2E and exact-run replay passed; 9,955 observations accepted, 1,881 coordinate claims rejected without dropping rows, 5,293 source-coordinate groups rendered approximate, 1,240 city/postal-only groups listable but unmapped; no recurring monitor; published PDF dictionary differs from current CSV; keep privacy, coordinate provenance, and release gates open; see `data/manifests/italy-1069-preview-e2e-20260924.json` |
