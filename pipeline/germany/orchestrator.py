...
def run_registered_input(raw_path, runs_dir, config, prior_eligible_release=None, suppressed_ids=None, adapter_runner=None):
    return _run_registered_input(raw_path, runs_dir, config, adapter_runner or _germany_adapter, suppressed_ids=suppressed_ids, prior_eligible_release=prior_eligible_release)
