-- A privacy-screened community claim may be explicitly published while
-- factually unreviewed. It remains outside curated profiles and must be
-- labeled by the API/frontend. Project approval is still required elsewhere.
...
COMMENT ON VIEW uec.map_facilities_display_history IS
    'V2 public display history; community profile may expose screened unreviewed claims with explicit labeling.';
