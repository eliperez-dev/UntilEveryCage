-- API-ready projection: presentation plus derived observation history/lifecycle.
...
LEFT JOIN uec.facility_observation_summary AS summary
  ON summary.facility_id = display.facility_id
