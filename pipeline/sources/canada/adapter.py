...
ALIASES = {
    "plant_number": ("plant number", "registration number", "establishment number", "establishment id", "plant id", "registration no"),
    "name": ("plant name", "operator name", "operators name", "name of operator", "establishment name", "operator", "name"),
    "doing_business_as": ("doing business as", "dba name", "also doing business as name", "trade name"),
    "address": ("address", "location address", "street address", "location"),
    "city": ("city", "location city", "municipality", "town"),
    "province": ("province", "location province", "prov", "state"),
    "postal_code": ("postal code", "postcode", "zip"),
    "phone": ("phone", "telephone", "telephone numbers", "contact phone"),
    "latitude": ("latitude", "lat", "y"),
    "longitude": ("longitude", "lon", "lng", "x"),
    "animal_class": ("animal class", "animal classes", "species", "species processed"),
